...
public interface SocksService {
    ...
    void addSocks(Color color, Size size, int cottonPercent, int quantity);

    Integer getSocksCount(Color color, Size size, int minCottonPercent, int maxCottonPercent);

    void releaseSocks(Color color, Size size, int cottonPercent, int quantity) throws InsufficientQuantityException;
}
